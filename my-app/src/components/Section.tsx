...
export const SkeletonThree = () => {
  return (
    <Link
      href="https://www.youtube.com/watch?v=IL470RpNNjo"
      target="__blank"
...
export const Globe = ({ className }: { className?: string }) => {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      mapSamples: 16000,
      mapBrightness: 6,
      baseColor: [0.0, 0.2, 0.55],
      markerColor: [0.1, 0.8, 1],
      glowColor: [1, 1, 1],
      markers: [
        // longitude latitude
  // latitude longitude for locations in Nepal
{ location: [27.7172, 85.3240], size: 0.03 }, // Kathmandu
{ location: [28.2096, 83.9856], size: 0.1 },  // Pokhara
{ location: [26.7280, 85.9248], size: 0.05 }  // Janakpur
